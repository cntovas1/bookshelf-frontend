...
function onFeatureSelect() {
  ...
  if (selectedFeature === "total_wire_length") {
    ...
    fetch("https://flask-backend-2pfq.onrender.com/calculate_wire_length")
      .then(response => {
        if (!response.ok) {
    ...
    nodeSearchDiv.style.display = "none";
    placementOptionsDiv.style.display = "none";
    fetch("https://flask-backend-2pfq.onrender.com/node_size_statistics")
      .then(response => {
        if (!response.ok) {
          throw new Error("Network response was not ok");
        }
    ...
    fetch("https://flask-backend-2pfq.onrender.com/largest_smallest_nets_hpwl")
    ...
    fetch("https://flask-backend-2pfq.onrender.com/legalize_placement", {
      method: "POST",
    })
      .then(response => response.json())
      .then(data => {
    ...
    nodeSearchDiv.style.display = "none";
    placementOptionsDiv.style.display = "none"; 
    fetch("https://flask-backend-2pfq.onrender.com/sorted_nets")
        .then(response => response.json())
        .then(data => {
            if (Array.isArray(data)) {
                outputDiv.innerHTML = `
  ...
  fetch("https://flask-backend-2pfq.onrender.com/detailed_placement", {
    method: "POST",
  })
    .then(response => response.json())
    .then(data => {
  ...
  fetch("https://flask-backend-2pfq.onrender.com/legality_check")
    .then(response => response.json())
    .then(data => {
    ...
    .catch(error => {
      ...
      modifyButton.addEventListener("click", function() {
        ...
        fetch("https://flask-backend-2pfq.onrender.com/modify_node_coordinates", {
          method: "POST",
          headers: {
...
function runPlacementAlgorithm() {
  ...
  if (selectedAlgorithm === "random") {
    fetch("https://flask-backend-2pfq.onrender.com/random_placement", { method: "POST" })
      .then(response => {
        if (!response.ok) {
          throw new Error("Network response was not ok");
        }
...
function calculateSpecificNetLength() {
  ...
  fetch(`https://flask-backend-2pfq.onrender.com/calculate_net_length/${netId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error("Network response was not ok");
      }
...
function getNodeCoordinates() {
  ...
  fetch(`https://flask-backend-2pfq.onrender.com/get_node_coordinates/${nodeId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error("Network response was not ok");
      }
...
function loadRandomVisualization() {
  fetch("https://flask-backend-2pfq.onrender.com/random_visualize_layout")
    .then(response => {
      if (!response.ok) {
        throw new Error("Network response was not ok");
      }
...
function onRandomFeatureSelect() {
  ...
  if (selectedFeature === "random_total_wire_length") {
    fetch("https://flask-backend-2pfq.onrender.com/random_calculate_wire_length")
      .then(response => response.json())
    ...
    fetch("https://flask-backend-2pfq.onrender.com/random_largest_smallest_nets_hpwl")
      .then(response => response.json())
      .then(data => {
        if (data.largest_net && data.smallest_net) {
          outputDiv.innerHTML = `
  ...
  fetch("https://flask-backend-2pfq.onrender.com/random_legality_check")
    .then(response => response.json())
    .then(data => {
      const summary = data.summary;
      outputDiv.innerHTML = `
    ...
    fetch("https://flask-backend-2pfq.onrender.com/random_sorted_nets")
        .then(response => response.json())
        .then(data => {
            if (Array.isArray(data)) {
                outputDiv.innerHTML = `
...
function modifyRandomNodePlacement() {
  ...
  fetch("https://flask-backend-2pfq.onrender.com/random_modify_node_coordinates", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
function calculateRandomSpecificNetLength() {
  ...
  fetch(`https://flask-backend-2pfq.onrender.com/random_calculate_net_length/${netId}`)
    .then(response => response.json())
    .then(data => {
      if (data.wire_length !== undefined) {
        outputDiv.innerHTML = `Wire Length for Net ${netId}: ${data.wire_length}`;
...
function calculateRandomNodeCoordinates() {
  ...
  fetch(`https://flask-backend-2pfq.onrender.com/random_node_coordinates?node_id=${nodeId}`)
    .then(response => response.json())
    .then(data => {
